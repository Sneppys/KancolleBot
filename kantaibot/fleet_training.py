...
TrainingDifficulty("Simple", 1, 1, 200, 200)
TrainingDifficulty("Easy", 10, 5, 300, 500)
TrainingDifficulty("Medium", 20, 10, 500, 650)
TrainingDifficulty("Hard", 35, 15, 1000, 2000)
TrainingDifficulty("Difficult", 45, 20, 2000, 5000)
TrainingDifficulty("Extreme", 65, 40, 4000, 8000)
